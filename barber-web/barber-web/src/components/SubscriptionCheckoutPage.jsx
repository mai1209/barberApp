...
const PLAN_META = {
  basic: {
    ...
    title: "Plan Básico",
    description:
      "Turnos online, cobro online y automatización base para tu barbería.",
  },
  pro: {
    label: "Pro",
    variant: "pro",
    title: "Plan Pro",
    description:
      "Métricas, historial y herramientas avanzadas para el negocio.",
  },
};
          ...
          <div className={styles.heroBlock}>
            ...
            <h1 className={styles.title}>
              ...
              <span className={styles.titleAccent}>
                {branding.checkout.accent}
              </span>
            </h1>
            <p className={styles.subtitle}>{branding.checkout.subtitle}</p>
          </div>
            ...
            {planCards.map((plan) => (
              ...
              >
                <div className={styles.planCardTop}>
                  <span
                    className={`${styles.planBadge} ${styles[`planBadge_${plan.variant}`]}`}
                  >
                    {plan.label}
                  </span>
                  <span
                    className={`${styles.planSelectedDot} ${
                      selectedPlan === plan.key
                        ? `${styles.planSelectedDotActive} ${styles[`planSelectedDot_${plan.variant}`]}`
                        : styles.planSelectedDotInactive
                    }`}
                  />
                </div>
                ...
                <div className={styles.planPricingRow}>
                  <strong
                    className={`${styles.planPrice} ${styles[`planPrice_${plan.variant}`]}`}
                  >
                    {plan.price}
                  </strong>
          ...
          <div className={styles.formCard}>
            ...
            <div className={styles.processorCard}>
              ...
              <div className={styles.processorCopy}>
                <span className={styles.processorLabel}>
                  Procesador de pago
                </span>
            ...
            {paymentMode === "automatic" ? (
              <div className={styles.warningBanner}>
                ...
                <span>
                  Importante: para renovación automática, Mercado Pago puede
                  rechazar tarjetas prepagas. Si falla, probá con una tarjeta de
                  crédito o débito tradicional.
                </span>
              </div>
            ) : null}
            ...
            <form onSubmit={handleSubmit} className={styles.form}>
              ...
              {paymentMode === "automatic" ? (
                <p className={styles.submitWarning}>
                  Si tu tarjeta es prepaga, usá pago mensual manual para evitar
                  rechazos en Mercado Pago.
                </p>
              ) : null}
            </form>
            ...
            <div className={styles.whatsappRow}>
              <p className={styles.whatsappHelper}>
                Si tenés dudas con el plan o querés un presupuesto especial,
                podés escribir por WhatsApp.
              </p>
              <a
            ...
            <div className={styles.downloadCard}>
              ...
              <div className={styles.downloadCardBody}>
                <p className={styles.downloadTitle}>
                  Después del alta, descargá la app
                </p>
                <p className={styles.downloadText}>
                  Cuando completes la activación, entrá a la app con esta misma
                  cuenta para empezar a usar tu barbería desde el celular.
                </p>
